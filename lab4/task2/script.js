...
function mouseDragged(x){
    ...
    // var matrixMultiplication2 = matrixMultiplication(makeIdentityMatrix(), vector);
    // var matrixMultiplication2 = matrixMultiplication(makeRotationMatrix(20), vector);
    // var matrixMultiplication2 = matrixMultiplication(makeTranslationMatrix(62,117), vector);
    var matrixMultiplication2 = matrixMultiplication(makeScalingMatrix(2,2), vector);
