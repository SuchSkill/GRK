...
function mouseDragged(x){
    ...
    var matrixMultiplication0 = matrixMultiplication(makeTranslationMatrix(62,117), makeScalingMatrix(2,2));
    var matrixMultiplication1 = matrixMultiplication(matrixMultiplication0, makeRotationMatrix(20));
    var matrixMultiplication2 = matrixMultiplication(matrixMultiplication1, vector);
